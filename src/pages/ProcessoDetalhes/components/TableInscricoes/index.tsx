...
export function TableInscricoes({
  ...
  return (
    <S.Section>
      ...
      {isLoadingInscricoes ? (
      ...
      ) : !resultAllInscricoes || resultAllInscricoes.length === 0 ? (
        <S.EmptyState>
        ...
        <S.InscricoesTableWrap>
          <S.InscricoesTable>
            ...
            <tbody>
              {resultAllInscricoes.map((i) => (
                <S.Tr key={i.id_inscricao}>
                  <S.Td>
                    <S.Muted>{i.data_criacao}</S.Muted>
                  </S.Td>

                  <S.Td>
                    <S.CellStrong title={i.usuario.candidato?.nome_completo}>
                  ...
                  <S.Td>
                    <S.CellClamp2 title={i.usuario.candidato?.logradouro}>
